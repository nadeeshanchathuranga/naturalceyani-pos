<template>
  ...
  <div class="flex flex-col md:flex-row md:items-center justify-between w-full mb-6 gap-4 md:gap-0">
...
<div class="flex flex-col w-full my-5 space-y-4 md:flex-row md:items-end md:space-y-0 md:justify-between border-2 border-black rounded-2xl px-6 py-4">
...
<div>
      <label for="total_to_include_guide" class="mb-1 text-lg font-semibold text-gray-700">
  ...
  <div class="w-full space-y-6">
    ...
    <div class="w-full border-2 border-black rounded-2xl p-6 bg-gray-50 shadow-md">
      ...
      <div class="flex flex-col mb-4">
        <label for="guide_name" class="mb-1 text-lg font-semibold text-gray-700">Guide Name</label>
        <input
          id="guide_name"
          type="text"
          v-model="guide_name"
    ...
    />
        ...
        <div class="w-full">
          <label for="guide_cash" class="mb-1 text-lg font-semibold text-gray-700">Cash (LKR)</label>
         <input
      id="guide_cash"
      type="number"
      v-model="guide_cash"
  ...
  <!-- Cheque Form (Visible only if Cheqe selected) -->
    ...
    <PosSuccessModel :open="isSuccessModalOpen" @update:open="handleModalOpenUpdate" :products="products.map((item, index) => ({
        ...
        :employee="employee" :cashier="loggedInUser" :customer="customer" :orderid="orderid" :cash="cash"   :isWholesale="isWholesale"   :credit_bill="credit_bill"
  ...
  :guide_name="guide_name"
    ...
    <div class="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50">
        ...
        <!-- Close Button -->
        <button @click="isModalOpen = false" class="absolute top-3 right-3 text-black text-3xl font-bold">&times;</button>

        <div class="flex flex-col w-full">
            <div class="flex flex-col w-full">
            <div class="flex flex-col items-center justify-center w-full space-y-8 border-4 border-black rounded-3xl p-4 mb-4">
